...
// Function to print a 10x10 matrix
...
// Function to rotate a 10x10 matrix 90 degrees clockwise
void rotate(char matrix[10][10]) {
    char rotMat[10][10]; // Temporary matrix for rotation
    int p2;
...
int main(int argc, char **argv) {
    ...
    rotate(matrix); // Rotate and print the matrix
